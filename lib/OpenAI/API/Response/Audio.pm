package OpenAI::API::Response::Audio;
...
OpenAI::API::Response::Audio - encapsulate the response from the OpenAI
Chat API.

=head1 SYNOPSIS

This module should not be used directly. It will be used by
L<OpenAI::API::Request::Audio> to parse and encapsulate the response.

=head1 DESCRIPTION

OpenAI::API::Response::Audio extends the L<OpenAI::API::Response>
...
The type of the object, which is "audio" for this module.
...
L<OpenAI::API::Request::Audio>, L<OpenAI::API::Response>
